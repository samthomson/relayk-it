---
title: Changelog
description: User-facing changes per RelayKit release. New versions ship as versioned images — update in place from the dashboard.
section: reference
order: 1
---

<!-- Maintained by hand. Copy user-facing notes from ../relaykit/app/CHANGELOG.md when you cut a release. -->
...
- Fix self-update: `release.yml` is baked into the image (0.2.4's update failed on a missing file).
